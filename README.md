...
In this case, this interface will use a USB-GPIB adapter, although there can be other variations like e.g. ethernet-GPIB, this will be the cheapest and quickest development path to be taken. 
